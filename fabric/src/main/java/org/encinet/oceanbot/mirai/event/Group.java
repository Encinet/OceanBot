...
import org.encinet.kitebot.common.command.sender.QQGroupSender;
import org.encinet.kitebot.file.Config;
import org.encinet.kitebot.mirai.consciousness.CS;
import org.encinet.kitebot.until.record.BindData;
import org.encinet.kitebot.until.HttpUnit;
import org.encinet.kitebot.until.Process;
import org.encinet.kitebot.until.QQUntil;
...
public class Group extends SimpleListenerHost {
    ...
    public void handleException(@NotNull CoroutineContext context, @NotNull Throwable exception) {
        // 处理事件处理时抛出的异常
        // 向工作群发送报错
        KiteBot.core.getBot().getGroup(LogGroup).sendMessage("Bot Error " + System.currentTimeMillis() + "\n" + exception);
